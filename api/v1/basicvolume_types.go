...
type BasicVolume struct {
	...
	Spec   BasicVolumeSpec   `json:"spec,omitempty"`
	Status BasicVolumeStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// BasicVolumeList contains a list of BasicVolume
type BasicVolumeList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BasicVolume `json:"items"`
}

func init() {
	SchemeBuilder.Register(&BasicVolume{}, &BasicVolumeList{})
}
